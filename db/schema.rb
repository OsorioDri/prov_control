...
ActiveRecord::Schema[7.1].define(version: 2024_11_16_215200) do
  ...
  add_foreign_key "municipalities", "users", column: "current_coordinator"
  add_foreign_key "municipalities", "users", column: "original_coordinator"
end
